...
import {ADPOD, BANNER, NATIVE, VIDEO} from '../src/mediaTypes';
...
/**
 *
 * this function will be remove was kept to clear some of the console errors
 * @param bids
 * @returns {*}
 */
 ...
 * @param bidRequest
 * @param bidderRequest
 * @returns {{bidderRequest: {gdprConsent}, method: string, data: string, options: {withCredentials: boolean, contentType: string}, url: string}}
 */
